<template>
  <div class="home">
    ...
    <example-code :code="code" type="javascript">
      <div class="flex justify-between lh-34">
        <span>Copy string directly.</span>
        <button
          class="button"
          @click="handleCopyDirectly('This is some text.')"
        >
          Copy to clipboard
        </button>
      </div>
    ...
    <example-code :code="code" type="html">
      <div class="flex justify-between lh-34">
        <input
          ...
          class="input"
          type="text"
          value="Copy by some Node."
        >
        <button
          class="button"
          @click="handleCopyByNode('#js-copy-by-node')"
        >
          Copy to clipboard
        </button>
      </div>
    ...
    <example-code :code="code" type="html">
      <div class="flex justify-between lh-34">
        <input
          id="js-copy-by-callback"
          class="input"
          type="text"
          value="Copy by some callback."
        >
        <button
          class="button"
          @click="handleCopyByNode('#js-copy-by-callback')"
        >
          Copy to clipboard
        </button>
      </div>
    ...
    <example-code :code="code" type="html">
      <div class="flex justify-between">
        ...
        <div>
          <button
            class="button"
            @click="handleCopyByNode('#js-copy-table')"
          >
            Copy to clipboard
          </button>
        </div>
